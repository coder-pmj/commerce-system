...
<html lang="en">
	<head>
		...
		<script src="../res/static/js/util/tab.js" async="async"></script>
		<script src="../res/static/js/util/index-tourist-click.js"></script>
				...
				<div class="inner-cont0">
					<div class="inner-cont1 w1200">
						<div class="inner-cont2">
							<a href="index-tourist.php" class="active">
								<h2>所有商品</h2>
							</a>
